...
client.on('message', msg => {
  ...
  if (a.includes(keyword.yeu)&&
  !msg.author.bot||
  a.includes(keyword.y3u)&&
  !msg.author.bot&&!a.includes(contract.love)||
  a.includes(keyword.love)&&
  !msg.author.bot){
    msg.channel.send(`yêu đương cái gì hả ${msg.author}!!`)
  }
//${msg.author}
  if (a.includes(keyword.ngu)||
  a.includes(keyword.sua)||
  a.includes(keyword.suatv)||
  a.includes(keyword.gay)&&
  !msg.author.bot||
  a.includes(keyword.gaytv)&&
  !msg.author.bot||
  ...
  if (a.includes(keyword.vl)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.dm)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.cac)&&a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.cacTV)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.lonTV)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.lonz)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.lol)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.cc)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.duma)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.du_ma)&& a.includes(keyword.wibu)&&
  !msg.author.bot||
  a.includes(keyword.du_maTV)&& a.includes(keyword.wibu)&&
  !msg.author.bot)
  {
    msg.channel.send(`mày tính làm j hả ${msg.author}, wibu thì làm sao nào`)
  }
  else {
    if (a.includes(keyword.vl)||
...
if(a.includes(keyword.keyword)){
  ...
  if (a.includes(contract.love)) {
      ...
      msg.channel.send(`Nico Yazawa cũng yêu ${msg.author} lắm nè <3 :heartbeat: `);
      msg.channel.send(attachment);
  }
});
